      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-lg p-8 mb-6 text-white">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold">Ferramentas CRM</h1>
              <p class="text-white/80 mt-1">Modulo de vendas e gestao de leads (mcp__crm__)</p>
            </div>
            <a
        ...
        @if (configService.hasData()) {
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <div class="text-3xl font-bold text-blue-600">
                  {{ configService.enabledCrmToolsCount() }}/{{ configService.crmTools().length }}
                </div>
              </div>
          ...
          <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div class="p-6">
              @if (configService.crmTools().length === 0) {
                <div class="text-center py-8 text-gray-500">
                  <p>Nenhuma ferramenta CRM configurada</p>
                </div>
              } @else {
                <div class="space-y-3">
                  @for (tool of configService.crmTools(); track tool.name) {
                    <div class="border rounded-xl p-4 pr-2 hover:shadow-md transition flex items-center justify-between gap-2"
                         [class.border-blue-300]="tool.enabled"
                         [class.bg-blue-50]="tool.enabled"
                      ...
                      <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-3 mb-1">
                          ...
                          <span class="px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded-full">CRM</span>
                        </div>
                      ...
                      <div class="flex-shrink-0 min-w-[44px]">
                        <button
                          ...
                          [class.bg-blue-500]="tool.enabled"
...
export class CrmToolsConfig implements OnInit {
